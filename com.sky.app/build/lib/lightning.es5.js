    ...
    _createClass(Component, [{
      ...
      value: function __bindProperty(propObj, targetObj, targetProp) {
        ...
        if (!this.hasOwnProperty(propName)) {
          this["__prop_bindings_".concat(propName)] = [{
            __obj: obj,
            __prop: prop,
            __func: func
          }];
          Object.defineProperty(this, propName, {
            set: function set(value) {
              ...
              this["__prop_".concat(propName)] = value;

              var _iterator = _createForOfIteratorHelper(this["__prop_bindings_".concat(propName)]),
                  _step;
            ...
            get: function get() {
              ...
              return this["__prop_".concat(propName)];
            }.bind(this)
          });
        } else {
          this["__prop_bindings_".concat(propName)].push({
            __obj: obj,
            __prop: prop,
            __func: func
          });
    ...
    _createClass(Application, [{
      ...
      value: function _destroy() {
        ...
        if (this.__keypressTimers.size) {
          var _iterator = _createForOfIteratorHelper(this.__keypressTimers.values()),
              _step;
